...
There is one nuclei template yaml file that can detect the security vulnerability in the repo here. With Nuclei automation, you can detect logsign products with critical security vulnerabilities with a single template yaml file. 
The exploitation stages of the vulnerabilities here will be added with python scripts and descriptions over time.
...
Single target:
nuclei -u http://target.com -t CVE-2024-5716.yaml -nh
